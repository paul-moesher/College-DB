...
Values ('Sam','Nasr', 111111111, '252 N College Blv', 'Vermillion','Ohio','44332',4196780909),
	   ('John','Frat-Guy', 222222222, '56 S Drive', 'Bowling Green','Ohio','44332',4196780909),
	   ('Jane','Purple-Hair', 333333333, '69 E Street', 'Vermillion','Ohio','44332',4196780909)
...
Values (1,1, 'Intro to programming', '2019-4-11', '2019-4-19', '2019-4-15', 110, 100),
       (2,2, 'Intimate weight lifting', '2019-4-12', '2019-4-20', '2019-4-16', 69,  69),
       (3,3, 'Intro to diversity', '2019-4-13', '2019-4-21', '2019-4-17', 5, 500)
